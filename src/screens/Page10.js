...
import OldAndNew from '../component/OldAndNew';
...
function Page10() {
    return <div>
        ...
        <Contents4
            ...
            oldAndNew={
                <OldAndNew
                    text1 = {'1964년 고구마 전분 공장'}
                    text2 = {'역사/예술이 파우더처럼 뿌려진 카페'}
                />
            }
        ...
        <Recommend
            ...
            recoCard={[
                <RecoCard 
                    ...
                    conTit = {'대정에서 온 남자, 성산에서 온 여자 part1.서귀포에 취한 젊음의 기록'}
                    desc = {<>여행 중이죠? 서로에 대한 배려가 싹틀 때, 걸음마다 팝콘처럼 터지는 기쁨이 있어요.</>}
                />,
                <RecoCard 
